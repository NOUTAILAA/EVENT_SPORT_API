...
public class Evenement {
    ...
    public Evenement(Long id, String nom, Date date, Double prix, boolean verified,
            Organisateur organisateur, TypeDeSport typeDeSport, Localisation localisation,
            List<Equipe> equipes, List<Participant> participants, List<Resultat> resultats) {
this.id = id;
this.nom = nom;
this.date = date;
this.prix = prix;
